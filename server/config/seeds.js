  ...
  const games = await Games.insertMany([
    {
      name: "minecraft",
      image:
        "https://res.cloudinary.com/zenbusiness/image/upload/v1670445040/logaster/logaster-2020-06-image14-3.png",
    },
    {
      name: "Roblox",
      image:
    ...
    {
      name: "Cod",
      image: "https://upload.wikimedia.org/wikipedia/commons/2/21/Logo_CoD.jpg",
    },
  ]);
